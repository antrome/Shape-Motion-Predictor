...
class SrivastavaGRU(nn.Module):
    def __init__(self, input_dim, hidden_dim, layer_dim, output_dim,dropout,seq_dim,pred_dim):
        super(SrivastavaGRU, self).__init__()
        # Hidden dimensions
        self.hidden_dim = hidden_dim
        ...
        # Building your LSTM
        self.encoder = nn.GRU(input_dim, hidden_dim, layer_dim, batch_first=True,dropout=dropout)
        self.future = nn.GRU(input_dim, hidden_dim, layer_dim, batch_first=True,dropout=dropout)
        self.input = nn.GRU(input_dim, hidden_dim, layer_dim, batch_first=True,dropout=dropout)
    ...
    def forward(self, x):
        ...
        # One time step
        outh, hnh = self.encoder(xh, h0h)

        outf, hn = self.future(x, hnh)
        outi, hn = self.input(outi, hnh)
...
class SrivastavaRNN(nn.Module):
    def __init__(self, input_dim, hidden_dim, layer_dim, output_dim,dropout,seq_dim,pred_dim):
        super(SrivastavaRNN, self).__init__()
        # Hidden dimensions
        self.hidden_dim = hidden_dim
        ...
        # Building your LSTM
        self.encoder = nn.RNN(input_dim, hidden_dim, layer_dim, batch_first=True,dropout=dropout)
        self.future = nn.RNN(input_dim, hidden_dim, layer_dim, batch_first=True,dropout=dropout)
        self.input = nn.RNN(input_dim, hidden_dim, layer_dim, batch_first=True,dropout=dropout)
